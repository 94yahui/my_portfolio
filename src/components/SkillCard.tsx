...
const SkillCard = ({ name, iconUrl }: SkillCardProps) => {
  return (
    <div className="relative p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600 hover:border-blue-400 hover:shadow-lg transition-all duration-300 min-w-32 overflow-hidden group">
      <img
        src={iconUrl}
        alt={name}
